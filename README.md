...
"2018年度最受欢迎中国开源软件评选":帮忙点收藏，要集150个收藏，还差***18***个,谢谢帮帮忙。<br>
...
包含定时任务调度、服务器监控、平台监控、异常邮件监控、服务器Down机邮件监控、平台设置、开发平台、邮件监控、图表监控、地图监控、单点登录、Redis分布式高速缓存、ActiveMQ队列、会员、营销、在线用户、日志、在线人数、访问次数、调用次数、直接集群、接口文档、生成模块、代码实例、安装视频、教程文档、springCloud、RedisMQ队列（待开发）、代码生成(增删改查单表、redis高速缓存对接代码、dubbo、增删改查云接口、图表统计、地图统计、vue.js)、工作流、CMS、代码生成(单表、主附表、树表、列表和表单、增删改查云接口、redis高速缓存对接代码、dubbo、图表统计、地图统计、vue.js)<br>
